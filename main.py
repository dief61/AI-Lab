...
@app.get("/")
def index_page(request: None = None):
...
def ui_config():
    """UI configuration endpoint for API v1."""
    return {
        "title": "Hallo Welt API",
        "version": "1.0.0",
        "endpoints": [
            {"path": "/", "method": "GET", "description": "Main HTML page"},
            {"path": "/greeting", "method": "GET", "description": "Greeting with mood parameter"},
